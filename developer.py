...
class Developer:
    def __init__(self,root):
        ...
        self.root.title("Smart Attendence system Using Facial Recognition")
...
# This part is image labels setting start 
       ...
       # std_img_btn=Image.open(r"Images_GUI\m.jpg")
        ...
        std_b1_1 = Button(bg_img,text="Swapnil Kuwar",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        det_b1_1 = Button(bg_img,text="Harshal Chaudhari",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        att_b1_1 = Button(bg_img,text="Aishwarya Mahajan",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        hlp_b1_1 = Button(bg_img,text="Prajakta More",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
